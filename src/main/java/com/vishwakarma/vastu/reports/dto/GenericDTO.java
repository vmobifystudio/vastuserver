package com.vishwakarma.vastu.reports.dto;
...
public class GenericDTO {
	...
	public String getField(int index) {
		try {
			return (String) GenericDTO.class.getField("field"+index).get(this);
	...
	public void setField(int index, String value) {
		try {
			GenericDTO.class.getField("field"+index).set(this, value);
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
		} catch (IllegalAccessException e) {
			e.printStackTrace();
