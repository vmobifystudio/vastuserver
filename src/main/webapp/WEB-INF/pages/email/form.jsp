...
<html>
<head>
	<link rel="stylesheet" type="text/css" media="screen" href='<c:url value="/assets/css/jquery-ui/pepper-grinder/jquery-ui-1.8.16.custom.css"/>'/>
<%-- 	<link rel="stylesheet" type="text/css" media="screen" href='<c:url value="/assets/css/email/style.css"/>'/> --%>
	<script type='text/javascript' src='<c:url value="/assets/js/jquery.js"/>'></script>
	<script type='text/javascript' src='<c:url value="/assets/js/jquery-ui-1.8.16.custom.min.js"/>'></script>
<%-- 	<script type='text/javascript' src='<c:url value="/assets/js/jquery.js"/>'></script> --%>
<%-- 	<script type='text/javascript' src='<c:url value="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.min.js"/>'></script> --%>
