...
<title>vastu - Update orderProduct</title>
...
<body>
	...
	<c:url value="/orderProduct/update" var="updateorderProduct"/>
	<form:form id="updateorderProduct" action="${updateorderProduct}" method="post" modelAttribute="orderProduct">
		<div>
		...
		<fieldset>
			<legend>Order</legend>
					...
					<div class="input-group width-xlarge">
						...
						<form:select path="products" multiple="true" cssClass="form-control">
